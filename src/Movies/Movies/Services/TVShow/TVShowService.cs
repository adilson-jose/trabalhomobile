...
namespace Movies.Services.TVShow
{
    public class TVShowService : ITVShowService
    {
        ...
        public async Task<Models.TVShow.TVShow> FindByIdAsync(int tvShowId, string language = "pt-BR")
        {
        ...
        public async Task<Models.TVShow.TVShow> GetLatestAsync(string language = "pt-BR")
        {
        ...
        public async Task<SearchResponse<Models.TVShow.TVShow>> GetPopularAsync(int pageNumber = 1, string language = "pt-BR")
        {
        ...
        public async Task<SearchResponse<Models.TVShow.TVShow>> GetTopRatedAsync(int pageNumber = 1, string language = "pt-BR")
        {
