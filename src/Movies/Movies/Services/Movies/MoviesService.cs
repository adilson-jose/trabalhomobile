...
namespace Movies.Services.Movies
{
    public class MoviesService : IMoviesService
    {
        ...
        public async Task<Movie> FindByIdAsync(int movieId, string language = "pt-BR")
        {
        ...
        public async Task<Movie> GetLatestAsync(string language = "pt-BR")
        {
        ...
        public async Task<SearchResponse<Movie>> GetPopularAsync(int pageNumber = 1, string language = "pt-BR")
        {
        ...
        public async Task<SearchResponse<Movie>> GetTopRatedAsync(int pageNumber = 1, string language = "pt-BR")
        {
        ...
        public async Task<SearchResponse<Movie>> GetUpcomingAsync(int pageNumber = 1, string language = "pt-BR")
        {
        ...
        public async Task<MovieCredit> GetCreditsAsync(int movieId, string language = "pt-BR")
        {
        ...
        public async Task<MovieVideo> GetVideosAsync(int movieId, string language = "pt-BR")
        {
