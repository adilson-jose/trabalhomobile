...
namespace Movies.Services.People
{
    public class PeopleService : IPeopleService
    {
        ...
        public async Task<Person> FindByIdAsync(int personId, string language = "pt-BR")
        {
        ...
        public async Task<SearchResponse<Person>> SearchByNameAsync(string query, int pageNumber = 1, string language = "pt-BR")
        {
        ...
        public async Task<PersonImage> GetImagesAsync(int personId, string language = "pt-BR")
        {
